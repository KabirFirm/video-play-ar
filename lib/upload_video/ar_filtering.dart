...
class ARFiltering extends StatefulWidget {
  const ARFiltering({Key? key}) : super(key: key);

  @override
  _ARFilteringState createState() => _ARFilteringState();
}

class _ARFilteringState extends State<ARFiltering> {
  ...
  void initState() {
    ...
    _controller.initialize(
      androidLicenseKey: androidDeepARKey,
      iosLicenseKey: iOSDeepARKey,
